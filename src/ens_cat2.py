...
for cfg in CONFIGS:
    for sd in (42, 7, 2026):
        for tr_i, va_i in folds:
            m = CatBoostClassifier(iterations=3000, random_seed=sd, cat_features=cats, verbose=0,
        ...
        nm += 1; print("cat2 member", nm, flush=True)
np.save(D+"../src/oof_cat9.npy", oof/nm); np.save(D+"../src/pte_cat9.npy", pte/nm)
print("CAT9 DONE")
